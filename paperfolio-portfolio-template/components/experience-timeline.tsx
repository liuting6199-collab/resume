...
const experiences = [
  {
    ...
    company: "广东科凯达智能科技有限公司（国家专精特新"小巨人"企业） - 产品规划部",
    role: "产品实习生",
    location: "广东",
    highlights: [
      "需求调研：实地走访风电场，与业主和一线运维人员沟通，梳理场站运维现状与现实痛点，进行需求收集、拆解、优先级排序，累计输出5份需求清单与现场调研报告。",
      "产品设计：基于公司数字化技术底座，参与一体化运维平台的业务架构与流程规划，围绕设备管理、智能巡检、安全管控、工单流转、数据可视化等场景拆解模块，完成30余份原型设计。",
      "项目落地：对接研发、测试、实施团队完成需求评审、技术对齐与落地推进，完成私有化部署下的功能适配调试，持续收集场站人员反馈并优化迭代，全流程跟进2个新能源数字化项目落地交付。"
    ],
    color: "#B45F4D"
  },
  {
